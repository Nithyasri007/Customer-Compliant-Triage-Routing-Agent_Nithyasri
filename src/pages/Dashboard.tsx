    ...
    const fetchDashboardStats = async () => {
      try {
        ...
        setDashboardStats({
          ...
          total_complaints_today: complaintsToday.length
        });
      } finally {
        setLoading(false);
      }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Using offline data</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                <AnimatedCounter value={dashboardStats.total_complaints_today} />
              </div>
        ...
        <GlassCard delay={0.1} className="p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                <AnimatedCounter value={dashboardStats.pending_complaints} />
              </div>
